module ALU (zero,
 ...
 sky130_fd_sc_hd__inv_2 _0833_ (.A(net169),
    .Y(_0008_));
 sky130_fd_sc_hd__inv_2 _0834_ (.A(net179),
    .Y(_0009_));
 ...
 sky130_fd_sc_hd__nand3b_2 _0847_ (.A_N(net154),
    ...
    .C(net155),
    .Y(_0022_));
 sky130_fd_sc_hd__and3_2 _0848_ (.A(net157),
    .B(_0020_),
    .C(_0021_),
    .X(_0023_));
 sky130_fd_sc_hd__mux4_2 _0849_ (.A0(net183),
    .A1(net172),
    .A2(net6),
    .A3(net7),
    .S0(net184),
    .S1(net174),
    .X(_0024_));
 sky130_fd_sc_hd__mux4_2 _0850_ (.A0(net201),
    .A1(net200),
    .A2(net210),
    .A3(net203),
    .S0(net186),
 ...
 sky130_fd_sc_hd__nor2_2 _0852_ (.A(net159),
    .B(_0022_),
    .Y(_0027_));
 sky130_fd_sc_hd__mux2_1 _0853_ (.A0(net206),
    .A1(net205),
    .S(net193),
    .X(_0028_));
 sky130_fd_sc_hd__mux4_2 _0854_ (.A0(net206),
    .A1(net205),
    .A2(net204),
    .A3(net202),
    .S0(net194),
    .S1(net180),
    .X(_0029_));
 sky130_fd_sc_hd__and2_2 _0855_ (.A(net169),
    .B(_0029_),
    .X(_0030_));
 sky130_fd_sc_hd__nor2_2 _0856_ (.A(net169),
    .B(net179),
    .Y(_0031_));
 sky130_fd_sc_hd__or2_2 _0857_ (.A(net169),
    .B(net179),
    .X(_0032_));
 ...
 sky130_fd_sc_hd__mux2_1 _0859_ (.A0(net23),
    ...
    .S(net193),
    .X(_0034_));
 sky130_fd_sc_hd__nor2_2 _0860_ (.A(net169),
    .B(net134),
    .Y(_0035_));
 ...
 sky130_fd_sc_hd__nor2_2 _0879_ (.A(net59),
    .B(_0053_),
    .Y(_0054_));
 sky130_fd_sc_hd__and3_2 _0880_ (.A(net150),
    .B(net147),
    .C(net131),
    .X(_0055_));
 ...
 sky130_fd_sc_hd__nand2_2 _0951_ (.A(net60),
    .B(net205),
    .Y(_0126_));
 sky130_fd_sc_hd__xnor2_2 _0952_ (.A(net60),
    .B(net205),
    .Y(_0127_));
 ...
 sky130_fd_sc_hd__xnor2_2 _0955_ (.A(net163),
    .B(net26),
    .Y(_0130_));
 sky130_fd_sc_hd__and2b_2 _0956_ (.A_N(net178),
    .B(net213),
    .X(_0131_));
 sky130_fd_sc_hd__nand2_2 _0957_ (.A(net179),
    .B(net213),
    .Y(_0132_));
 sky130_fd_sc_hd__xnor2_2 _0958_ (.A(net178),
    .B(net12),
    .Y(_0133_));
 ...
 sky130_fd_sc_hd__a21o_2 _0960_ (.A1(_0133_),
    ...
    .B1(_0131_),
    .X(_0135_));
 sky130_fd_sc_hd__or2_2 _0961_ (.A(net169),
    .B(net23),
    .X(_0136_));
 sky130_fd_sc_hd__nand2_2 _0962_ (.A(net168),
    .B(net23),
    .Y(_0137_));
 ...
 sky130_fd_sc_hd__nand2_2 _0964_ (.A(_0135_),
    .B(_0138_),
    .Y(_0139_));
 sky130_fd_sc_hd__and2b_2 _0965_ (.A_N(net168),
    .B(net23),
    .X(_0140_));
 ...
 sky130_fd_sc_hd__a31o_2 _0968_ (.A1(_0130_),
    ...
    .B1(_0142_),
    .X(_0143_));
 sky130_fd_sc_hd__nand2_2 _0969_ (.A(net157),
    .B(net206),
    .Y(_0144_));
 sky130_fd_sc_hd__or2_2 _0970_ (.A(net157),
    .B(net206),
    .X(_0145_));
 ...
 sky130_fd_sc_hd__nor2_2 _0974_ (.A(net62),
    .B(net202),
    .Y(_0149_));
 sky130_fd_sc_hd__or2_2 _0975_ (.A(net62),
    .B(net202),
    .X(_0150_));
 sky130_fd_sc_hd__nand2_2 _0976_ (.A(net62),
    .B(net202),
    .Y(_0151_));
 ...
 sky130_fd_sc_hd__or2_2 _0980_ (.A(net61),
    .B(net204),
    .X(_0155_));
 sky130_fd_sc_hd__xor2_2 _0981_ (.A(net61),
    .B(net204),
    .X(_0156_));
 ...
 sky130_fd_sc_hd__nand2b_2 _0988_ (.A_N(net61),
    .B(net204),
    .Y(_0163_));
 sky130_fd_sc_hd__o21ai_2 _0989_ (.A1(net128),
    .A2(_0162_),
    .B1(_0163_),
    .Y(_0164_));
 ...
 sky130_fd_sc_hd__nand2_2 _0991_ (.A(net37),
    .B(net172),
    .Y(_0166_));
 sky130_fd_sc_hd__xnor2_2 _0992_ (.A(net37),
    .B(net172),
    .Y(_0167_));
 sky130_fd_sc_hd__or2_2 _0993_ (.A(net36),
    .B(net183),
    .X(_0168_));
 sky130_fd_sc_hd__nand2_2 _0994_ (.A(net36),
    .B(net183),
    .Y(_0169_));
 sky130_fd_sc_hd__nand2_2 _0995_ (.A(_0168_),
    .B(_0169_),
    .Y(_0170_));
 sky130_fd_sc_hd__nand2_2 _0996_ (.A(net127),
    .B(_0170_),
    .Y(_0171_));
 sky130_fd_sc_hd__nor2_2 _0997_ (.A(net38),
    .B(net6),
    .Y(_0172_));
 sky130_fd_sc_hd__and2_2 _0998_ (.A(net38),
    .B(net6),
    .X(_0173_));
 ...
 sky130_fd_sc_hd__nand2_2 _1012_ (.A(_0184_),
    .B(_0185_),
    .Y(_0187_));
 sky130_fd_sc_hd__nand2_2 _1013_ (.A(net63),
    .B(net201),
    .Y(_0188_));
 sky130_fd_sc_hd__or2_2 _1014_ (.A(net63),
    .B(net201),
    .X(_0189_));
 ...
 sky130_fd_sc_hd__or2_2 _1031_ (.A(_0177_),
    .B(_0205_),
    .X(_0206_));
 sky130_fd_sc_hd__o221a_2 _1032_ (.A1(net39),
    .A2(_0004_),
    .B1(_0178_),
    .B2(_0199_),
    .C1(_0206_),
 ...
 sky130_fd_sc_hd__mux2_1 _1072_ (.A0(_0244_),
    ...
    .S(net135),
    .X(_0246_));
 sky130_fd_sc_hd__mux2_1 _1073_ (.A0(net20),
    .A1(net21),
    .S(net198),
    .X(_0247_));
 sky130_fd_sc_hd__mux2_1 _1074_ (.A0(net18),
    .A1(net19),
    .S(net191),
    .X(_0248_));
 sky130_fd_sc_hd__mux2_1 _1075_ (.A0(_0247_),
    ...
    .S(net134),
    .X(_0249_));
 sky130_fd_sc_hd__mux2_1 _1076_ (.A0(net22),
    .A1(net24),
    .S(net198),
    .X(_0250_));
 ...
 sky130_fd_sc_hd__a22o_2 _1086_ (.A1(_0243_),
    ...
    .B2(_0259_),
    .X(_0260_));
 sky130_fd_sc_hd__mux4_2 _1087_ (.A0(net172),
    .A1(net6),
    .A2(net7),
    .A3(net153),
    .S0(net185),
 ...
 sky130_fd_sc_hd__mux2_1 _1089_ (.A0(_0261_),
    ...
    .S(net136),
    .X(_0263_));
 sky130_fd_sc_hd__mux2_1 _1090_ (.A0(net205),
    .A1(net204),
    .S(net194),
    .X(_0264_));
 sky130_fd_sc_hd__mux4_2 _1091_ (.A0(net205),
    .A1(net204),
    .A2(net202),
    .A3(net201),
    .S0(net194),
 ...
 sky130_fd_sc_hd__mux2_1 _1092_ (.A0(net213),
    ...
    .S(net195),
    .X(_0266_));
 sky130_fd_sc_hd__mux2_1 _1093_ (.A0(net207),
    .A1(net206),
    .S(net195),
    .X(_0267_));
 ...
 sky130_fd_sc_hd__o21ai_2 _1097_ (.A1(net179),
    ...
    .B1(net122),
    .Y(_0271_));
 sky130_fd_sc_hd__o221a_2 _1098_ (.A1(net113),
    .A2(_0132_),
    .B1(_0133_),
    .B2(net117),
    .C1(_0271_),
 ...
 sky130_fd_sc_hd__o211ai_2 _1109_ (.A1(_0274_),
    ...
    .C1(_0272_),
    .Y(_0283_));
 sky130_fd_sc_hd__a211o_2 _1110_ (.A1(net157),
    .A2(_0260_),
    .B1(_0270_),
    .C1(_0283_),
    .X(net80));
 ...
 sky130_fd_sc_hd__and4_2 _1116_ (.A(net209),
    ...
    .D(net65),
    .X(_0289_));
 sky130_fd_sc_hd__and2b_2 _1117_ (.A_N(net182),
    .B(net171),
    .X(_0290_));
 ...
 sky130_fd_sc_hd__mux2_1 _1124_ (.A0(_0295_),
    ...
    .S(net136),
    .X(_0297_));
 sky130_fd_sc_hd__mux4_2 _1125_ (.A0(net204),
    .A1(net202),
    .A2(net201),
    .A3(net200),
    .S0(net186),
 ...
 sky130_fd_sc_hd__or2_2 _1132_ (.A(_0135_),
    .B(_0138_),
    .X(_0305_));
 sky130_fd_sc_hd__nor2_2 _1133_ (.A(net117),
    .B(_0138_),
    .Y(_0306_));
 sky130_fd_sc_hd__nand2_2 _1134_ (.A(net181),
    .B(net1),
    .Y(_0307_));
 sky130_fd_sc_hd__mux2_1 _1135_ (.A0(net23),
    ...
    .S(net195),
    .X(_0308_));
 sky130_fd_sc_hd__o2bb2a_2 _1136_ (.A1_N(net134),
    .A2_N(_0308_),
    .B1(_0307_),
    .B2(net195),
    .X(_0309_));
 sky130_fd_sc_hd__nor2_2 _1137_ (.A(net169),
    .B(_0309_),
    .Y(_0310_));
 sky130_fd_sc_hd__a221o_2 _1138_ (.A1(net121),
    ...
    .C1(_0306_),
    .X(_0311_));
 sky130_fd_sc_hd__a31o_2 _1139_ (.A1(net169),
    .A2(net23),
    .A3(net115),
    .B1(_0311_),
    .X(_0312_));
 sky130_fd_sc_hd__a311o_2 _1140_ (.A1(_0139_),
    ...
    .C1(_0304_),
    .X(_0313_));
 sky130_fd_sc_hd__a211o_2 _1141_ (.A1(net158),
    .A2(_0294_),
    .B1(_0301_),
    .C1(_0313_),
    .X(net91));
 ...
 sky130_fd_sc_hd__mux2_1 _1159_ (.A0(_0329_),
    ...
    .S(net136),
    .X(_0331_));
 sky130_fd_sc_hd__mux4_2 _1160_ (.A0(net202),
    .A1(net201),
    .A2(net200),
    .A3(net210),
    .S0(net186),
 ...
 sky130_fd_sc_hd__or4b_2 _1169_ (.A(_0325_),
    ...
    .D_N(_0340_),
    .X(_0341_));
 sky130_fd_sc_hd__a21o_2 _1170_ (.A1(net157),
    .A2(_0322_),
    .B1(_0341_),
    .X(net94));
 ...
 sky130_fd_sc_hd__xor2_2 _1181_ (.A(_0143_),
    .B(_0146_),
    .X(_0352_));
 sky130_fd_sc_hd__mux4_2 _1182_ (.A0(net206),
    .A1(net207),
    .A2(net23),
    .A3(net213),
    .S0(net196),
 ...
 sky130_fd_sc_hd__a22o_2 _1185_ (.A1(_0055_),
    ...
    .B2(_0145_),
    .X(_0356_));
 sky130_fd_sc_hd__a31o_2 _1186_ (.A1(net157),
    .A2(net27),
    .A3(net115),
    .B1(_0356_),
    .X(_0357_));
 ...
 sky130_fd_sc_hd__a22o_2 _1188_ (.A1(net102),
    ...
    .B2(net125),
    .X(_0359_));
 sky130_fd_sc_hd__a211o_2 _1189_ (.A1(net157),
    .A2(_0351_),
    .B1(_0357_),
    .C1(_0359_),
    .X(_0360_));
 ...
 sky130_fd_sc_hd__nand2_2 _1191_ (.A(_0144_),
    .B(_0344_),
    .Y(_0361_));
 sky130_fd_sc_hd__xnor2_2 _1192_ (.A(net130),
    .B(_0361_),
    .Y(_0362_));
 ...
 sky130_fd_sc_hd__o22a_2 _1202_ (.A1(_0041_),
    ...
    .B2(net112),
    .X(_0372_));
 sky130_fd_sc_hd__o22a_2 _1203_ (.A1(net117),
    .A2(net130),
    .B1(_0370_),
    .B2(_0056_),
    .X(_0373_));
 ...
 sky130_fd_sc_hd__mux4_2 _1205_ (.A0(_0245_),
    ...
    .S1(net149),
    .X(_0375_));
 sky130_fd_sc_hd__a22o_2 _1206_ (.A1(net158),
    .A2(_0368_),
    .B1(_0375_),
    .B2(net125),
    .X(_0376_));
 ...
 sky130_fd_sc_hd__a221o_2 _1218_ (.A1(net121),
    ...
    .C1(_0386_),
    .X(_0387_));
 sky130_fd_sc_hd__mux4_2 _1219_ (.A0(net204),
    .A1(net205),
    .A2(net206),
    .A3(net207),
    .S0(net194),
 ...
 sky130_fd_sc_hd__mux2_1 _1225_ (.A0(_0392_),
    ...
    .S(net165),
    .X(_0394_));
 sky130_fd_sc_hd__and3_2 _1226_ (.A(net165),
    .B(_0016_),
    .C(net132),
    .X(_0395_));
 ...
 sky130_fd_sc_hd__a22o_2 _1228_ (.A1(_0243_),
    ...
    .B2(_0254_),
    .X(_0397_));
 sky130_fd_sc_hd__a211o_2 _1229_ (.A1(net157),
    .A2(_0397_),
    .B1(_0391_),
    .C1(_0387_),
    .X(_0398_));
 sky130_fd_sc_hd__a31o_2 _1230_ (.A1(net102),
    .A2(_0383_),
    .A3(_0384_),
    .B1(_0398_),
    .X(_0399_));
 sky130_fd_sc_hd__a21o_2 _1231_ (.A1(net108),
    .A2(_0382_),
    .B1(_0399_),
    .X(net97));
 ...
 sky130_fd_sc_hd__nand2_2 _1247_ (.A(_0413_),
    .B(_0414_),
    .Y(_0415_));
 sky130_fd_sc_hd__o221a_2 _1248_ (.A1(net165),
    .A2(_0411_),
    .B1(_0415_),
    .B2(_0284_),
    .C1(net160),
 ...
 sky130_fd_sc_hd__and3_2 _1253_ (.A(net102),
    ...
    .C(_0419_),
    .X(_0420_));
 sky130_fd_sc_hd__or4_2 _1254_ (.A(net130),
    .B(_0146_),
    .C(_0153_),
    .D(_0157_),
    .X(_0421_));
 ...
 sky130_fd_sc_hd__a21o_2 _1260_ (.A1(net149),
    ...
    .B1(_0412_),
    .X(_0427_));
 sky130_fd_sc_hd__and3_2 _1261_ (.A(net158),
    .B(_0021_),
    .C(_0427_),
    .X(_0428_));
 sky130_fd_sc_hd__o22ai_2 _1262_ (.A1(net113),
    .A2(_0188_),
    .B1(_0190_),
    .B2(net117),
    .Y(_0429_));
 ...
 sky130_fd_sc_hd__a21oi_2 _1269_ (.A1(_0026_),
    ...
    .B1(_0435_),
    .Y(_0436_));
 sky130_fd_sc_hd__nor2_2 _1270_ (.A(net157),
    .B(_0436_),
    .Y(_0437_));
 ...
 sky130_fd_sc_hd__a2bb2o_2 _1302_ (.A1_N(net112),
    ...
    .B2(net121),
    .X(_0467_));
 sky130_fd_sc_hd__a2bb2o_2 _1303_ (.A1_N(net116),
    .A2_N(_0182_),
    .B1(_0463_),
    .B2(net124),
    .X(_0468_));
 ...
 sky130_fd_sc_hd__or3_2 _1305_ (.A(_0467_),
    ...
    .C(_0469_),
    .X(_0470_));
 sky130_fd_sc_hd__a31o_2 _1306_ (.A1(net108),
    .A2(_0460_),
    .A3(_0461_),
    .B1(_0470_),
    .X(_0471_));
 sky130_fd_sc_hd__a31o_2 _1307_ (.A1(net102),
    .A2(_0457_),
    .A3(_0458_),
    .B1(_0471_),
    .X(net70));
 ...
 sky130_fd_sc_hd__a211o_2 _1324_ (.A1(net124),
    ...
    .C1(_0479_),
    .X(_0488_));
 sky130_fd_sc_hd__a211o_2 _1325_ (.A1(net102),
    .A2(_0473_),
    .B1(_0476_),
    .C1(_0488_),
    .X(net71));
 ...
 sky130_fd_sc_hd__o31a_2 _1332_ (.A1(net126),
    ...
    .B1(_0494_),
    .X(_0495_));
 sky130_fd_sc_hd__or3_2 _1333_ (.A(net126),
    .B(_0182_),
    .C(_0454_),
    .X(_0496_));
 ...
 sky130_fd_sc_hd__a311oi_2 _1336_ (.A1(_0170_),
    ...
    .C1(net107),
    .Y(_0499_));
 sky130_fd_sc_hd__mux2_1 _1337_ (.A0(net183),
    .A1(net3),
    .S(net184),
    .X(_0500_));
 ...
 sky130_fd_sc_hd__or3_2 _1348_ (.A(_0492_),
    ...
    .C(_0510_),
    .X(net72));
 sky130_fd_sc_hd__or3b_2 _1349_ (.A(net127),
    .B(_0200_),
    .C_N(_0491_),
    .X(_0511_));
 ...
 sky130_fd_sc_hd__and3_2 _1351_ (.A(_0201_),
    ...
    .C(_0512_),
    .X(_0513_));
 sky130_fd_sc_hd__nand2_2 _1352_ (.A(net127),
    .B(_0169_),
    .Y(_0514_));
 sky130_fd_sc_hd__o21a_2 _1353_ (.A1(net127),
    .A2(_0169_),
    .B1(net108),
    .X(_0515_));
 ...
 sky130_fd_sc_hd__xnor2_2 _1369_ (.A(_0174_),
    .B(_0529_),
    .Y(_0530_));
 sky130_fd_sc_hd__o21a_2 _1370_ (.A1(net127),
    .A2(_0169_),
    .B1(_0166_),
    .X(_0531_));
 ...
 sky130_fd_sc_hd__mux2_1 _1378_ (.A0(_0390_),
    ...
    .S(net147),
    .X(_0539_));
 sky130_fd_sc_hd__or2_2 _1379_ (.A(net165),
    .B(_0393_),
    .X(_0540_));
 ...
 sky130_fd_sc_hd__mux2_1 _1398_ (.A0(_0409_),
    ...
    .S(net145),
    .X(_0558_));
 sky130_fd_sc_hd__a221o_2 _1399_ (.A1(net158),
    .A2(_0555_),
    .B1(_0558_),
    .B2(net104),
    .C1(_0554_),
 ...
 sky130_fd_sc_hd__a21o_2 _1421_ (.A1(_0212_),
    ...
    .B1(net105),
    .X(_0580_));
 sky130_fd_sc_hd__o22ai_2 _1422_ (.A1(net113),
    .A2(_0211_),
    .B1(_0578_),
    .B2(_0051_),
    .Y(_0581_));
 ...
 sky130_fd_sc_hd__a32o_2 _1437_ (.A1(net41),
    ...
    .B2(_0577_),
    .X(_0595_));
 sky130_fd_sc_hd__or4_2 _1438_ (.A(net105),
    .B(_0593_),
    .C(_0594_),
    .D(_0595_),
    .X(_0596_));
 ...
 sky130_fd_sc_hd__a32o_2 _1460_ (.A1(net108),
    ...
    .B2(net151),
    .X(_0617_));
 sky130_fd_sc_hd__or4_2 _1461_ (.A(net105),
    .B(_0605_),
    .C(_0611_),
    .D(_0617_),
    .X(net78));
 ...
 sky130_fd_sc_hd__o21a_2 _1474_ (.A1(_0322_),
    ...
    .B1(net151),
    .X(_0630_));
 sky130_fd_sc_hd__or3b_2 _1475_ (.A(net105),
    .B(_0630_),
    .C_N(_0624_),
    .X(_0631_));
 ...
 sky130_fd_sc_hd__a211o_2 _1493_ (.A1(_0354_),
    ...
    .C1(_0647_),
    .X(_0648_));
 sky130_fd_sc_hd__a21o_2 _1494_ (.A1(net151),
    .A2(_0645_),
    .B1(_0648_),
    .X(_0649_));
 sky130_fd_sc_hd__a211o_2 _1495_ (.A1(net103),
    .A2(_0633_),
    .B1(_0640_),
    .C1(_0649_),
    .X(net81));
 ...
 sky130_fd_sc_hd__nor2_2 _1535_ (.A(net116),
    .B(_0114_),
    .Y(_0687_));
 sky130_fd_sc_hd__a2bb2o_2 _1536_ (.A1_N(net113),
    .A2_N(_0113_),
    .B1(_0111_),
    .B2(net122),
    .X(_0688_));
 ...
 sky130_fd_sc_hd__a31o_2 _1544_ (.A1(net109),
    ...
    .B1(_0695_),
    .X(_0696_));
 sky130_fd_sc_hd__a211o_2 _1545_ (.A1(net103),
    .A2(_0684_),
    .B1(_0694_),
    .C1(_0696_),
    .X(net84));
 ...
 sky130_fd_sc_hd__a221oi_2 _1560_ (.A1(net125),
    ...
    .C1(_0710_),
    .Y(_0711_));
 sky130_fd_sc_hd__o31a_2 _1561_ (.A1(net107),
    .A2(_0703_),
    .A3(_0704_),
    .B1(_0711_),
    .X(_0712_));
 ...
 sky130_fd_sc_hd__a311o_2 _1592_ (.A1(net109),
    ...
    .C1(_0740_),
    .X(_0741_));
 sky130_fd_sc_hd__a31o_2 _1593_ (.A1(net103),
    .A2(_0728_),
    .A3(_0729_),
    .B1(_0741_),
    .X(net87));
 ...
 sky130_fd_sc_hd__a211o_2 _1605_ (.A1(_0483_),
    ...
    .C1(_0752_),
    .X(_0753_));
 sky130_fd_sc_hd__a31o_2 _1606_ (.A1(net103),
    .A2(_0742_),
    .A3(_0743_),
    .B1(_0753_),
    .X(_0754_));
 sky130_fd_sc_hd__a31o_2 _1607_ (.A1(net109),
    .A2(_0744_),
    .A3(_0745_),
    .B1(_0754_),
    .X(net88));
 ...
 sky130_fd_sc_hd__o31ai_2 _1622_ (.A1(_0765_),
    ...
    .B1(_0081_),
    .Y(_0769_));
 sky130_fd_sc_hd__and3_2 _1623_ (.A(net109),
    .B(_0768_),
    .C(_0769_),
    .X(_0770_));
 sky130_fd_sc_hd__a211o_2 _1624_ (.A1(net150),
    .A2(_0505_),
    .B1(_0763_),
    .C1(_0770_),
    .X(_0771_));
 sky130_fd_sc_hd__a31o_2 _1625_ (.A1(net103),
    .A2(_0755_),
    .A3(_0756_),
    .B1(_0771_),
    .X(net89));
 ...
 sky130_fd_sc_hd__a41o_2 _1637_ (.A1(_0074_),
    ...
    .B1(_0780_),
    .X(_0783_));
 sky130_fd_sc_hd__a31o_2 _1638_ (.A1(net109),
    .A2(_0781_),
    .A3(_0782_),
    .B1(_0783_),
    .X(net90));
 ...
 sky130_fd_sc_hd__nor2_2 _1641_ (.A(_0784_),
    .B(_0785_),
    .Y(_0786_));
 sky130_fd_sc_hd__nor2_2 _1642_ (.A(net113),
    .B(_0065_),
    .Y(_0787_));
 ...
 sky130_fd_sc_hd__a211o_2 _1647_ (.A1(net111),
    ...
    .C1(net106),
    .X(_0792_));
 sky130_fd_sc_hd__a221o_2 _1648_ (.A1(net151),
    .A2(_0542_),
    .B1(_0575_),
    .B2(_0678_),
    .C1(_0792_),
 ...
 sky130_fd_sc_hd__a21bo_2 _1655_ (.A1(_0065_),
    ...
    .B1_N(_0063_),
    .X(_0799_));
 sky130_fd_sc_hd__and3_2 _1656_ (.A(net109),
    .B(_0798_),
    .C(_0799_),
    .X(_0800_));
 ...
 sky130_fd_sc_hd__o221a_2 _1658_ (.A1(_0063_),
    ...
    .C1(_0273_),
    .X(_0802_));
 sky130_fd_sc_hd__nor2_2 _1659_ (.A(net113),
    .B(_0061_),
    .Y(_0803_));
 ...
 sky130_fd_sc_hd__or4_2 _1668_ (.A(_0800_),
    ...
    .D(_0811_),
    .X(net93));
 sky130_fd_sc_hd__or4_2 _1669_ (.A(net72),
    .B(net73),
    .C(net76),
    .D(net77),
    .X(_0812_));
 sky130_fd_sc_hd__or2_2 _1670_ (.A(net98),
    .B(net70),
    .X(_0813_));
 sky130_fd_sc_hd__or4_2 _1671_ (.A(net80),
    .B(net91),
    .C(net94),
    .D(net95),
    .X(_0814_));
 sky130_fd_sc_hd__or2_2 _1672_ (.A(net96),
    .B(_0814_),
    .X(_0815_));
 sky130_fd_sc_hd__or3_2 _1673_ (.A(net97),
    .B(net99),
    .C(net100),
    .X(_0816_));
 ...
 sky130_fd_sc_hd__or2_2 _1676_ (.A(net85),
    .B(net86),
    .X(_0819_));
 sky130_fd_sc_hd__or4_2 _1677_ (.A(net87),
    .B(_0817_),
    .C(_0818_),
    .D(_0819_),
    .X(_0820_));
 sky130_fd_sc_hd__or4_2 _1678_ (.A(net69),
    .B(net88),
    .C(net89),
    .D(_0820_),
    .X(_0821_));
 sky130_fd_sc_hd__or4_2 _1679_ (.A(net75),
    .B(net78),
    .C(net81),
    .D(net82),
    .X(_0822_));
 sky130_fd_sc_hd__or2_2 _1680_ (.A(net79),
    .B(net83),
    .X(_0823_));
 sky130_fd_sc_hd__or4_2 _1681_ (.A(net84),
    .B(net90),
    .C(_0822_),
    .D(_0823_),
    .X(_0824_));
 sky130_fd_sc_hd__nor4_2 _1682_ (.A(net92),
    .B(net93),
    .C(_0821_),
    .D(_0824_),
    .Y(net101));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout103 (.A(_0273_),
    .X(net103));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout105 (.A(_0552_),
    .X(net105));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout106 (.A(_0552_),
    .X(net106));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout107 (.A(_0278_),
    .X(net107));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout108 (.A(_0277_),
    .X(net108));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout109 (.A(_0277_),
    .X(net109));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout111 (.A(_0055_),
    .X(net111));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout112 (.A(net113),
    .X(net112));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout113 (.A(_0050_),
    .X(net113));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout116 (.A(net117),
    .X(net116));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout117 (.A(_0045_),
    .X(net117));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout125 (.A(_0027_),
    .X(net125));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout131 (.A(_0052_),
    .X(net131));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout132 (.A(_0031_),
    .X(net132));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout133 (.A(net134),
    .X(net133));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout134 (.A(_0009_),
    .X(net134));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout139 (.A(net141),
    .X(net139));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout141 (.A(_0008_),
    .X(net141));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout142 (.A(_0008_),
    .X(net142));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout147 (.A(net148),
    .X(net147));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout148 (.A(_0007_),
    .X(net148));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout149 (.A(_0007_),
    .X(net149));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout150 (.A(net151),
    .X(net150));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout151 (.A(_0006_),
    .X(net151));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout152 (.A(net9),
    .X(net152));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout153 (.A(net8),
    .X(net153));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout154 (.A(net68),
    .X(net154));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout155 (.A(net66),
    .X(net155));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout156 (.A(net65),
    .X(net156));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout157 (.A(net158),
    .X(net157));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout158 (.A(net59),
    .X(net158));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout163 (.A(net165),
    .X(net163));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout165 (.A(net58),
    .X(net165));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout166 (.A(net171),
    .X(net166));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout168 (.A(net170),
    .X(net168));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout170 (.A(net55),
    .X(net170));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout172 (.A(net5),
    .X(net172));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout173 (.A(net176),
    .X(net173));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout175 (.A(net176),
    .X(net175));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout176 (.A(net182),
    .X(net176));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout178 (.A(net181),
    .X(net178));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout180 (.A(net182),
    .X(net180));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout182 (.A(net44),
    .X(net182));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout183 (.A(net4),
    .X(net183));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout190 (.A(net192),
    .X(net190));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout192 (.A(net33),
    .X(net192));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout193 (.A(net196),
    .X(net193));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout195 (.A(net196),
    .X(net195));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout196 (.A(net199),
    .X(net196));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout197 (.A(net199),
    .X(net197));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout199 (.A(net33),
    .X(net199));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout200 (.A(net32),
    .X(net200));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout201 (.A(net31),
    .X(net201));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout202 (.A(net30),
    .X(net202));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout203 (.A(net3),
    .X(net203));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout204 (.A(net29),
    .X(net204));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout205 (.A(net28),
    .X(net205));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout206 (.A(net27),
    .X(net206));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout208 (.A(net25),
    .X(net208));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout209 (.A(net25),
    .X(net209));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout210 (.A(net2),
    .X(net210));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout211 (.A(net14),
    .X(net211));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout212 (.A(net13),
    .X(net212));
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew171 (.A(net170),
    .X(net171));
 sky130_fd_sc_hd__clkbuf_4 load_slew174 (.A(net173),
    .X(net174));
 sky130_fd_sc_hd__clkbuf_4 load_slew179 (.A(net178),
    .X(net179));
 sky130_fd_sc_hd__buf_2 load_slew181 (.A(net180),
    .X(net181));
 sky130_fd_sc_hd__clkbuf_2 load_slew185 (.A(net184),
    .X(net185));
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap126 (.A(_0179_),
    .X(net126));
 sky130_fd_sc_hd__buf_2 max_cap127 (.A(_0167_),
    .X(net127));
 sky130_fd_sc_hd__clkbuf_2 max_cap128 (.A(_0156_),
    .X(net128));
 sky130_fd_sc_hd__clkbuf_2 max_cap129 (.A(_0130_),
    .X(net129));
 sky130_fd_sc_hd__clkbuf_2 max_cap130 (.A(_0127_),
    .X(net130));
