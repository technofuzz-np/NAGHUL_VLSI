module registerfile (clk,
 ...
 sky130_fd_sc_hd__nor2_2 _2498_ (.A(net10),
    .B(net9),
    .Y(_1030_));
 sky130_fd_sc_hd__or3b_2 _2499_ (.A(net827),
    .B(net683),
    .C_N(net669),
    .X(_1031_));
 ...
 sky130_fd_sc_hd__mux2_1 _2818_ (.A0(\register[26][13] ),
    ...
    .S(net843),
    .X(_1337_));
 sky130_fd_sc_hd__o22a_2 _2819_ (.A1(net688),
    .A2(_1336_),
    .B1(_1337_),
    .B2(net654),
    .X(_1338_));
 ...
 sky130_fd_sc_hd__o22a_2 _3078_ (.A1(net653),
    ...
    .B2(net686),
    .X(_1585_));
 sky130_fd_sc_hd__o211a_2 _3079_ (.A1(net736),
    .A2(_1582_),
    .B1(_1585_),
    .C1(net560),
    .X(_1586_));
 sky130_fd_sc_hd__mux4_2 _3080_ (.A0(\register[28][25] ),
    ...
    .S1(net777),
    .X(_1587_));
 sky130_fd_sc_hd__or2_2 _3081_ (.A(net736),
    .B(_1587_),
    .X(_1588_));
 ...
 sky130_fd_sc_hd__o22a_2 _3089_ (.A1(net686),
    ...
    .B2(net653),
    .X(_1596_));
 sky130_fd_sc_hd__o211a_2 _3090_ (.A1(net736),
    .A2(_1593_),
    .B1(_1596_),
    .C1(net671),
    .X(_1597_));
 ...
 sky130_fd_sc_hd__o22a_2 _3094_ (.A1(net653),
    ...
    .B2(net686),
    .X(_1601_));
 sky130_fd_sc_hd__o211a_2 _3095_ (.A1(net736),
    .A2(_1598_),
    .B1(_1601_),
    .C1(net564),
    .X(_1602_));
 ...
 sky130_fd_sc_hd__mux2_1 _3127_ (.A0(\register[26][27] ),
    ...
    .S(net786),
    .X(_1632_));
 sky130_fd_sc_hd__o22a_2 _3128_ (.A1(net673),
    .A2(_1631_),
    .B1(_1632_),
    .B2(net638),
    .X(_1633_));
 ...
 sky130_fd_sc_hd__nor2_2 _3232_ (.A(net1005),
    .B(net1007),
    .Y(_1732_));
 sky130_fd_sc_hd__nor2_2 _3233_ (.A(net1047),
    .B(net1017),
    .Y(_1733_));
 sky130_fd_sc_hd__or2_2 _3234_ (.A(net1047),
    .B(net1017),
    .X(_1734_));
 sky130_fd_sc_hd__or3b_2 _3235_ (.A(net613),
    .B(net1118),
    .C_N(net629),
    .X(_1735_));
 ...
 sky130_fd_sc_hd__and2b_2 _3238_ (.A_N(net1017),
    .B(net1047),
    .X(_1738_));
 sky130_fd_sc_hd__nand2b_2 _3239_ (.A_N(net1017),
    .B(net1047),
    .Y(_1739_));
 ...
 sky130_fd_sc_hd__o211a_2 _3696_ (.A1(net716),
    ...
    .C1(_2175_),
    .X(_2176_));
 sky130_fd_sc_hd__a31o_2 _3697_ (.A1(net581),
    .A2(_2167_),
    .A3(_2170_),
    .B1(_2176_),
    .X(_2177_));
 ...
 sky130_fd_sc_hd__o211a_2 _3812_ (.A1(net717),
    ...
    .C1(net574),
    .X(_2287_));
 sky130_fd_sc_hd__a31o_2 _3813_ (.A1(net578),
    .A2(_2275_),
    .A3(_2278_),
    .B1(_2287_),
    .X(_2288_));
 ...
 sky130_fd_sc_hd__o211a_2 _3832_ (.A1(net708),
    ...
    .C1(net577),
    .X(_2306_));
 sky130_fd_sc_hd__a22o_2 _3833_ (.A1(net574),
    .A2(_2293_),
    .B1(_2301_),
    .B2(net633),
    .X(_2307_));
 ...
 sky130_fd_sc_hd__o22a_2 _3842_ (.A1(net618),
    ...
    .B2(net597),
    .X(_2315_));
 sky130_fd_sc_hd__o211a_2 _3843_ (.A1(net721),
    .A2(_2312_),
    .B1(_2315_),
    .C1(net579),
    .X(_2316_));
 ...
 sky130_fd_sc_hd__a22o_2 _3903_ (.A1(net1018),
    ...
    .B2(net601),
    .X(_2373_));
 sky130_fd_sc_hd__a21o_2 _3904_ (.A1(net626),
    .A2(_2371_),
    .B1(_2373_),
    .X(_2374_));
 ...
 sky130_fd_sc_hd__o22a_2 _3944_ (.A1(net615),
    ...
    .B2(net595),
    .X(_2413_));
 sky130_fd_sc_hd__a32o_2 _3945_ (.A1(net578),
    .A2(_2410_),
    .A3(_2413_),
    .B1(_2397_),
    .B2(net581),
 ...
 sky130_fd_sc_hd__and2b_2 _4800_ (.A_N(net994),
    .B(\register[0][22] ),
    .X(_0991_));
 sky130_fd_sc_hd__and2b_2 _4801_ (.A_N(net1004),
    .B(\register[0][23] ),
    .X(_0992_));
 ...
 sky130_fd_sc_hd__and2b_2 _4805_ (.A_N(net992),
    .B(\register[0][27] ),
    .X(_0996_));
 sky130_fd_sc_hd__and2b_2 _4806_ (.A_N(net1004),
    .B(\register[0][28] ),
    .X(_0997_));
 sky130_fd_sc_hd__and2b_2 _4807_ (.A_N(net993),
    .B(\register[0][29] ),
    .X(_0998_));
 sky130_fd_sc_hd__and2b_2 _4808_ (.A_N(net1004),
    .B(\register[0][30] ),
    .X(_0999_));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1001 (.A(net1002),
    .X(net1001));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1002 (.A(net1004),
    .X(net1002));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1004 (.A(net16),
    .X(net1004));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1005 (.A(net15),
    .X(net1005));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1006 (.A(net15),
    .X(net1006));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1007 (.A(net1008),
    .X(net1007));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1008 (.A(net14),
    .X(net1008));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1009 (.A(net1011),
    .X(net1009));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1011 (.A(net1019),
    .X(net1011));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1013 (.A(net1019),
    .X(net1013));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1015 (.A(net1019),
    .X(net1015));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1016 (.A(net1019),
    .X(net1016));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1018 (.A(net1020),
    .X(net1018));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1019 (.A(net13),
    .X(net1019));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1025 (.A(net1027),
    .X(net1025));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1027 (.A(net1037),
    .X(net1027));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1035 (.A(net1037),
    .X(net1035));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1037 (.A(net12),
    .X(net1037));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1044 (.A(net1054),
    .X(net1044));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1046 (.A(net1048),
    .X(net1046));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1048 (.A(net1055),
    .X(net1048));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1050 (.A(net1052),
    .X(net1050));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1052 (.A(net1054),
    .X(net1052));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1054 (.A(net12),
    .X(net1054));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1056 (.A(net1059),
    .X(net1056));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1058 (.A(net1075),
    .X(net1058));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1060 (.A(net1064),
    .X(net1060));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1062 (.A(net1064),
    .X(net1062));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1064 (.A(net1075),
    .X(net1064));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1065 (.A(net1069),
    .X(net1065));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1067 (.A(net1069),
    .X(net1067));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1069 (.A(net1075),
    .X(net1069));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1070 (.A(net1074),
    .X(net1070));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1072 (.A(net1074),
    .X(net1072));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1074 (.A(net1075),
    .X(net1074));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1075 (.A(net1136),
    .X(net1075));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1076 (.A(net1080),
    .X(net1076));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1078 (.A(net1080),
    .X(net1078));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1080 (.A(net1085),
    .X(net1080));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1081 (.A(net1085),
    .X(net1081));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1083 (.A(net1085),
    .X(net1083));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1085 (.A(net1136),
    .X(net1085));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1086 (.A(net1095),
    .X(net1086));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1088 (.A(net1095),
    .X(net1088));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1090 (.A(net1092),
    .X(net1090));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1092 (.A(net1094),
    .X(net1092));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1094 (.A(net1136),
    .X(net1094));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1096 (.A(net1098),
    .X(net1096));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1098 (.A(net1105),
    .X(net1098));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1100 (.A(net1104),
    .X(net1100));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1102 (.A(net1104),
    .X(net1102));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1104 (.A(net1136),
    .X(net1104));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1106 (.A(net1108),
    .X(net1106));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1108 (.A(net1136),
    .X(net1108));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1110 (.A(net1114),
    .X(net1110));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1112 (.A(net1114),
    .X(net1112));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1114 (.A(net1136),
    .X(net1114));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1115 (.A(net1117),
    .X(net1115));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1117 (.A(net1135),
    .X(net1117));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1119 (.A(net1123),
    .X(net1119));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1121 (.A(net1123),
    .X(net1121));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1123 (.A(net1135),
    .X(net1123));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1124 (.A(net1128),
    .X(net1124));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1126 (.A(net1128),
    .X(net1126));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1128 (.A(net1134),
    .X(net1128));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1129 (.A(net1131),
    .X(net1129));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1131 (.A(net1133),
    .X(net1131));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1133 (.A(net1135),
    .X(net1133));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1135 (.A(net1136),
    .X(net1135));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout1136 (.A(net11),
    .X(net1136));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout503 (.A(net509),
    .X(net503));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout505 (.A(net507),
    .X(net505));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout547 (.A(_2418_),
    .X(net547));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout549 (.A(_1735_),
    .X(net549));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout551 (.A(_1735_),
    .X(net551));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout552 (.A(_1735_),
    .X(net552));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout554 (.A(_1735_),
    .X(net554));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout565 (.A(_1032_),
    .X(net565));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout566 (.A(_1031_),
    .X(net566));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout568 (.A(_1031_),
    .X(net568));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout569 (.A(_1031_),
    .X(net569));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout571 (.A(_1031_),
    .X(net571));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout572 (.A(net574),
    .X(net572));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout573 (.A(net574),
    .X(net573));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout574 (.A(_1761_),
    .X(net574));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout575 (.A(net578),
    .X(net575));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout576 (.A(net578),
    .X(net576));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout577 (.A(net578),
    .X(net577));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout578 (.A(_1753_),
    .X(net578));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout579 (.A(net581),
    .X(net579));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout580 (.A(net581),
    .X(net580));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout581 (.A(_1748_),
    .X(net581));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout582 (.A(net585),
    .X(net582));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout584 (.A(net597),
    .X(net584));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout586 (.A(net588),
    .X(net586));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout588 (.A(net597),
    .X(net588));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout590 (.A(net592),
    .X(net590));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout592 (.A(net597),
    .X(net592));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout593 (.A(net595),
    .X(net593));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout595 (.A(net597),
    .X(net595));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout597 (.A(_1739_),
    .X(net597));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout598 (.A(net599),
    .X(net598));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout599 (.A(_1738_),
    .X(net599));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout600 (.A(_1738_),
    .X(net600));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout601 (.A(_1738_),
    .X(net601));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout602 (.A(net605),
    .X(net602));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout604 (.A(net618),
    .X(net604));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout606 (.A(net609),
    .X(net606));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout608 (.A(net617),
    .X(net608));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout610 (.A(net612),
    .X(net610));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout612 (.A(net618),
    .X(net612));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout613 (.A(net615),
    .X(net613));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout615 (.A(net618),
    .X(net615));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout617 (.A(_1734_),
    .X(net617));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout619 (.A(net622),
    .X(net619));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout621 (.A(net626),
    .X(net621));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout623 (.A(net626),
    .X(net623));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout625 (.A(net626),
    .X(net625));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout626 (.A(_1733_),
    .X(net626));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout627 (.A(net632),
    .X(net627));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout629 (.A(net632),
    .X(net629));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout631 (.A(net633),
    .X(net631));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout632 (.A(_1732_),
    .X(net632));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout634 (.A(net637),
    .X(net634));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout637 (.A(_1054_),
    .X(net637));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout638 (.A(net647),
    .X(net638));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout640 (.A(net646),
    .X(net640));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout642 (.A(net644),
    .X(net642));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout644 (.A(net647),
    .X(net644));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout650 (.A(net656),
    .X(net650));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout652 (.A(net654),
    .X(net652));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout654 (.A(net657),
    .X(net654));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout656 (.A(_1035_),
    .X(net656));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout658 (.A(net662),
    .X(net658));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout660 (.A(net662),
    .X(net660));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout662 (.A(_1034_),
    .X(net662));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout673 (.A(net675),
    .X(net673));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout675 (.A(net681),
    .X(net675));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout677 (.A(net679),
    .X(net677));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout679 (.A(net681),
    .X(net679));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout681 (.A(_1029_),
    .X(net681));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout682 (.A(net684),
    .X(net682));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout684 (.A(net690),
    .X(net684));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout686 (.A(net688),
    .X(net686));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout688 (.A(net691),
    .X(net688));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout690 (.A(_1029_),
    .X(net690));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout692 (.A(net696),
    .X(net692));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout694 (.A(net696),
    .X(net694));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout726 (.A(net728),
    .X(net726));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout728 (.A(net731),
    .X(net728));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout734 (.A(net740),
    .X(net734));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout736 (.A(net739),
    .X(net736));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout738 (.A(net741),
    .X(net738));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout740 (.A(_1024_),
    .X(net740));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout747 (.A(net8),
    .X(net747));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout749 (.A(net751),
    .X(net749));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout751 (.A(net8),
    .X(net751));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout752 (.A(net765),
    .X(net752));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout764 (.A(net765),
    .X(net764));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout765 (.A(net7),
    .X(net765));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout773 (.A(net780),
    .X(net773));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout775 (.A(net780),
    .X(net775));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout777 (.A(net780),
    .X(net777));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout779 (.A(net780),
    .X(net779));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout780 (.A(net7),
    .X(net780));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout781 (.A(net785),
    .X(net781));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout783 (.A(net785),
    .X(net783));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout785 (.A(net822),
    .X(net785));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout786 (.A(net790),
    .X(net786));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout788 (.A(net790),
    .X(net788));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout790 (.A(net822),
    .X(net790));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout791 (.A(net795),
    .X(net791));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout793 (.A(net795),
    .X(net793));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout795 (.A(net822),
    .X(net795));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout796 (.A(net800),
    .X(net796));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout798 (.A(net800),
    .X(net798));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout800 (.A(net822),
    .X(net800));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout801 (.A(net805),
    .X(net801));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout803 (.A(net805),
    .X(net803));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout805 (.A(net820),
    .X(net805));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout806 (.A(net810),
    .X(net806));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout808 (.A(net810),
    .X(net808));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout810 (.A(net820),
    .X(net810));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout811 (.A(net821),
    .X(net811));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout813 (.A(net821),
    .X(net813));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout815 (.A(net819),
    .X(net815));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout817 (.A(net819),
    .X(net817));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout819 (.A(net821),
    .X(net819));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout820 (.A(net822),
    .X(net820));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout822 (.A(net6),
    .X(net822));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout823 (.A(net825),
    .X(net823));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout825 (.A(net832),
    .X(net825));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout831 (.A(net863),
    .X(net831));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout833 (.A(net835),
    .X(net833));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout835 (.A(net864),
    .X(net835));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout837 (.A(net841),
    .X(net837));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout839 (.A(net841),
    .X(net839));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout841 (.A(net864),
    .X(net841));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout842 (.A(net844),
    .X(net842));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout844 (.A(net851),
    .X(net844));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout846 (.A(net850),
    .X(net846));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout848 (.A(net850),
    .X(net848));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout850 (.A(net851),
    .X(net850));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout851 (.A(net863),
    .X(net851));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout852 (.A(net856),
    .X(net852));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout854 (.A(net857),
    .X(net854));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout862 (.A(net863),
    .X(net862));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout863 (.A(net6),
    .X(net863));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout993 (.A(net16),
    .X(net993));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout994 (.A(net1004),
    .X(net994));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input10 (.A(rs1[4]),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input11 (.A(rs2[0]),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input12 (.A(rs2[1]),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input13 (.A(rs2[2]),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input14 (.A(rs2[3]),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input15 (.A(rs2[4]),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input16 (.A(rst),
    .X(net16));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input5 (.A(rd[4]),
    .X(net5));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input6 (.A(rs1[0]),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input7 (.A(rs1[1]),
    .X(net7));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input8 (.A(rs1[2]),
    .X(net8));
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew1017 (.A(net1016),
    .X(net1017));
 sky130_fd_sc_hd__clkbuf_4 load_slew1020 (.A(net1019),
    .X(net1020));
 ...
 sky130_fd_sc_hd__buf_4 load_slew1045 (.A(net1044),
    .X(net1045));
 sky130_fd_sc_hd__clkbuf_4 load_slew1047 (.A(net1046),
    .X(net1047));
 ...
 sky130_fd_sc_hd__buf_4 load_slew1055 (.A(net1054),
    .X(net1055));
 sky130_fd_sc_hd__buf_2 load_slew1057 (.A(net1056),
    .X(net1057));
 ...
 sky130_fd_sc_hd__buf_2 load_slew1097 (.A(net1096),
    .X(net1097));
 sky130_fd_sc_hd__buf_4 load_slew1099 (.A(net1098),
    .X(net1099));
 ...
 sky130_fd_sc_hd__buf_4 load_slew616 (.A(net615),
    .X(net616));
 sky130_fd_sc_hd__buf_4 load_slew618 (.A(net617),
    .X(net618));
 ...
 sky130_fd_sc_hd__buf_4 load_slew655 (.A(net654),
    .X(net655));
 sky130_fd_sc_hd__buf_2 load_slew657 (.A(net656),
    .X(net657));
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew670 (.A(net669),
    .X(net670));
 sky130_fd_sc_hd__buf_2 load_slew674 (.A(net673),
    .X(net674));
 sky130_fd_sc_hd__clkbuf_4 load_slew678 (.A(net677),
    .X(net678));
 sky130_fd_sc_hd__clkbuf_4 load_slew680 (.A(net679),
    .X(net680));
 sky130_fd_sc_hd__clkbuf_4 load_slew683 (.A(net682),
    .X(net683));
 sky130_fd_sc_hd__buf_4 load_slew687 (.A(net686),
    .X(net687));
 sky130_fd_sc_hd__buf_4 load_slew689 (.A(net688),
    .X(net689));
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew735 (.A(net734),
    .X(net735));
 sky130_fd_sc_hd__buf_2 load_slew737 (.A(net736),
    .X(net737));
 ...
 sky130_fd_sc_hd__buf_2 load_slew748 (.A(net747),
    .X(net748));
 sky130_fd_sc_hd__buf_4 load_slew750 (.A(net749),
    .X(net750));
 ...
 sky130_fd_sc_hd__buf_2 load_slew774 (.A(net773),
    .X(net774));
 sky130_fd_sc_hd__buf_4 load_slew776 (.A(net775),
    .X(net776));
 ...
 sky130_fd_sc_hd__buf_2 load_slew824 (.A(net823),
    .X(net824));
 sky130_fd_sc_hd__clkbuf_4 load_slew826 (.A(net825),
    .X(net826));
 ...
 sky130_fd_sc_hd__buf_4 load_slew855 (.A(net854),
    .X(net855));
 sky130_fd_sc_hd__clkbuf_4 load_slew857 (.A(net856),
    .X(net857));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 output107 (.A(net107),
    .X(rd2[3]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output108 (.A(net108),
    .X(rd2[4]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output109 (.A(net109),
    .X(rd2[5]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output110 (.A(net110),
    .X(rd2[6]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output111 (.A(net111),
    .X(rd2[7]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output112 (.A(net112),
    .X(rd2[8]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output113 (.A(net113),
    .X(rd2[9]));
 ...
 sky130_fd_sc_hd__clkbuf_4 wire591 (.A(net590),
    .X(net591));
 sky130_fd_sc_hd__clkbuf_4 wire603 (.A(net602),
    .X(net603));
 ...
 sky130_fd_sc_hd__clkbuf_4 wire643 (.A(net642),
    .X(net643));
 sky130_fd_sc_hd__clkbuf_4 wire647 (.A(net646),
    .X(net647));
